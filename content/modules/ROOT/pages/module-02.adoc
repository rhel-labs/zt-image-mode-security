...
Now that we have our new image built, the lab environment has automatically deployed a virtual machine from this security-hardened image. Let's test the security controls in the next module!
